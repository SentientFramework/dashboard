...
> Real-time monitoring dashboard for model performance and infrastructure health - part of the [SentientFramework](https://github.com/SentientFramework) open-source ecosystem.
...
The `dashboard` application is the web frontend for SentientFramework, built with Next.js for fast page loads, great developer experience, and easy deployment.
...
```bash
git clone https://github.com/SentientFramework/dashboard
cd dashboard
npm install
```
...
- **GitHub Issues:** [github.com/SentientFramework/issues](https://github.com/SentientFramework)
- **Discussions:** [github.com/SentientFramework/discussions](https://github.com/SentientFramework)
